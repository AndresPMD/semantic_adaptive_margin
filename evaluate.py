...
parser.add_argument('--data_path', default='/data2fast/users/amafla/Precomp_features/data/', help='path to dataset ')
parser.add_argument('--data_name', default='coco', help='{coco,f30k}_precomp')
parser.add_argument('--model_path', default='./runs/coco/CVSE_scratch_mini_5/model_best.pth.tar',help='Path to load the model.')
#parser.add_argument('--model_path', default='.runs/coco/CVSE_scratch/model_best.pth.tar',help='Path to load the model.')
...
parser.add_argument('--concept_path', default='./data/coco_annotations/Concept_annotations/',
